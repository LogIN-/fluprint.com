<template>
    <div class="container-fluid">
        <div class="boxes">
            ...
            <div class="intro">
                A research project that investigates influenza vaccines imprint on immune system funded by the European Commission as a part of the Marie Sklodowska-Curie Research Program.
            </div>

            <section>
                <div class="heading">The problem</div>
                <div class="row block">
                    <div class="col-sm-4">
                        <img class="img-fluid" src="about/section_1.png">
                    </div>
            ...
            <section>
                <div class="heading">The idea</div>
                <div class="row block">
                    <div class="col-sm-4">
                        <img class="img-fluid" src="about/section_2.png">
                    </div>
                    <div class="col-sm-8 description">
